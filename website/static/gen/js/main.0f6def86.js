...
var light3=new THREE.DirectionalLight(0xa165ff,1)
light3.position.x=-2.5;light3.position.y=-1.5;light3.position.z=-2;scene.add(light3)
...
var star_cluster_geometry=new THREE.SphereBufferGeometry(3,20,15);var star_cluster_material=new THREE.PointsMaterial({size:0.015,transparent:true,color:0xc22900})
