...
var star_cluster_geometry=new THREE.SphereBufferGeometry(1.5,25,15);var star_cluster_material=new THREE.PointsMaterial({size:0.02,transparent:true,color:'white'})
...
mesh1.rotation.y+=0.01;mesh2.rotation.x+=0.01;particles_mesh.rotation.y=(.0009*elasped_time)
