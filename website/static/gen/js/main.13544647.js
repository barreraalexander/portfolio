let lastKnownScrollPosition=0;let ticking=false;let run1=false;let run2=false;let run3=false;let project1=document.querySelector('#project1');let project2=document.querySelector('#project2');let project3=document.querySelector('#project3');function doSomething(scrollPos){console.log(scrollPos)
if(scrollPos>700){if(!run1){project1.classList.add('transformed_project')
run1=true;}}else if(scrollPos<700){project1.classList.remove('transformed_project')
run1=false;}if(scrollPos>900){if(!run2){project1.classList.remove('transformed_project')
project2.classList.add('transformed_project')
run2=true;}}else if(scrollPos<900){project2.classList.remove('transformed_project')
run2=false;}}if(scrollPos>1100){if(!run3){project2.classList.remove('transformed_project')
project3.classList.add('transformed_project')
run3=true;}}else if(scrollPos<1100){project3.classList.remove('transformed_project')
run3=false;}}
