let lastKnownScrollPosition=0;let ticking=false;function doSomething(scrollPos){console.log(scrollPos)
if(90<=scrollPos<=100){alert('passed')}else if(1200<=scrollPos<=1250){alert('passed')}
}
