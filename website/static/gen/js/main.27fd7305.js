...
function alter_image(scrollPos){let filter_max=100
if(scrollPos>2500){if(filter_min<filter_max){img.style.filter='grayscale('+filter_min.toString()+')%'
filter_min+=10;console.log(img)
}
}}
