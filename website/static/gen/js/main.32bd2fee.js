...
var particles=new THREE.Geometry(),var pMaterial=new THREE.ParticleBasicMaterial({color:0xFFFFFF,size:20});var render=function(){requestAnimationFrame(render)
