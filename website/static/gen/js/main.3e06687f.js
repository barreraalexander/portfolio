document.body.addEventListener('scroll',function(){alert('scrolled')})
let lastKnownScrollPosition=0;let ticking=false;function doSomething(scrollPos){alert('scrolled')
}
