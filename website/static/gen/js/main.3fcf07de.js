...
if(digitals){colors=["red","orange","yellow","green","blue","indigo","violet"]
do{for(let digit of digitals){random=Math.floor(Math.random()*colors.length)
digit.style.backgroundColor=colors[random];}}
while(1>0);}