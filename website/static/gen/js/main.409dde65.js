...
var star_cluster_geometry=new THREE.SphereBufferGeometry(.5,15,15);var star_cluster_material=new THREE.PointsMaterial({size:0.01,transparent:true,color:'white'})
