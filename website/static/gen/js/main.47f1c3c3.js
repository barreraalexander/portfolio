...
mesh1.rotation.y+=0.01;mesh2.rotation.x+=0.01;star_cluster_mesh.rotation.x+=0.0001;star_cluster_mesh2.rotation.x+=-0.0001;star_cluster_mesh.position.x+=.0009*-mouse_y;star_cluster_mesh2.position.x+=-0.0001;particles_mesh.rotation.y=(.0009*elasped_time)
