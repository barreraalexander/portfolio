let lastKnownScrollPosition=0;let ticking=false;let run1=false;function doSomething(scrollPos){console.log(scrollPos)
if(scrollPos>700){if(!run1){let project1=document.querySelector('#project1');project1.classList.add('transformed_project')
run1=true;}}else if(scrollPos<700||scrollPos>900){project1.classList.remove('transformed_project')
run1=false;}}
