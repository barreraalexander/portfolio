let lastKnownScrollPosition=0;let ticking=false;function doSomething(scrollPos){if(90<=scrollPos<=100){console.log(scrollPos)}else if(1200<=scrollPos<=1250){console.log(scrollPos)
}
}
