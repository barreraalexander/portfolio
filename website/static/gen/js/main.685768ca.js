...
if(scrollPos>10){divider.classList.add("dissolving_div")}}
function check_no_scroll(scrollPos){let divider=document.querySelector('.shimmering_div')
if(scrollPos>10){divider.style.height="10em"
divider.style.top="-10em"
divider.style.position="relative"}}
document.addEventListener('scroll',function(e){lastKnownScrollPosition=window.scrollY;if(!ticking){window.requestAnimationFrame(function(){shift_digital(lastKnownScrollPosition);alter_image(lastKnownScrollPosition);dissolve_divider(lastKnownScrollPosition);check_no_scroll(lastKnownScrollPosition)
