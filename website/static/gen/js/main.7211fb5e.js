let lastKnownScrollPosition=0;let ticking=false;let run1=false;let project1=document.querySelector('#project1');function doSomething(scrollPos){console.log(scrollPos)
