...
function dissolve_divider(scrollPos){if(scrollPos>100){divider.classList.add("dissolving_div")}}
seconds_to_wait
function check_no_scroll(scrollPos){setTimeout(function(){divider.classList.add("enlarge_div")
setTimeout(function(){divider.classList.add("dissolving_div")},30000/3)},30000/2)
}
