...
var star_cluster_geometry=new THREE.SphereBufferGeometry(3,20,15);var star_cluster_material=new THREE.PointsMaterial({size:0.02,transparent:true,metalness:.7,color:0xc22900})
...
var star_cluster_geometry2=new THREE.SphereBufferGeometry(2,20,15);var star_cluster_material2=new THREE.PointsMaterial({size:0.003,transparent:true,color:0xa165ff})
