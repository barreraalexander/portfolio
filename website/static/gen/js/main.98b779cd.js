...
run1=true;}}if(scrollPos<700){project1.classList.remove('transformed_project')
run1=false;}if(scrollPos>1160){if(!run2){project2.classList.add('transformed_project')
run2=true;}}}
