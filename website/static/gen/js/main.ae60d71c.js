...
if(1000>scrollPos>700){if(!run1){project1.classList.add('transformed_project')
run1=true;}}else if(scrollPos<700){project1.classList.remove('transformed_project')
run1=false;}else if(scrollPos>900){if(!run2){project2.classList.add('transformed_project')
project2.document.querySelector('.shifting_grill_ctnr').style.display="none"
run2=true;}}}
