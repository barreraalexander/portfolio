...
var geometry=new THREE.SphereBufferGeometry(1,20,20);var material=new THREE.MeshLambertMaterial({color:0x77FFC0});var mesh3=new THREE.Mesh(geometry,material)
mesh3.position.x=-2.5;mesh3.position.y=-1.5;mesh3.position.z=-2;scene.add(mesh3)
...
light3.position.x=-2.5;light3.position.y=-1.5;light3.position.z=-10;scene.add(light3)
...
var star_cluster_geometry=new THREE.SphereBufferGeometry(3,20,15);var star_cluster_material=new THREE.PointsMaterial({size:0.015,transparent:true,metalness:.7,color:0xc22900})
...
star_cluster_mesh2.position.x=-2.5;star_cluster_mesh2.position.y=-1.5;star_cluster_mesh2.position.z=-5;scene.add(star_cluster_mesh2)
...
mesh1.rotation.y+=0.01;mesh2.rotation.x+=0.01;star_cluster_mesh.rotation.x+=0.001;star_cluster_mesh2.rotation.x+=-0.001;particles_mesh.rotation.y=(.0009*elasped_time)
