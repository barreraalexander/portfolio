let lastKnownScrollPosition=0;let ticking=false;let run1=false;let run2=false;let project1=document.querySelector('#project1');let project2=document.querySelector('#project2');function doSomething(scrollPos){console.log(scrollPos)
