...
document.addEventListener('scroll',function(e){lastKnownScrollPosition=window.scrollY;if(!ticking){window.requestAnimationFrame(function(){shift_digital(lastKnownScrollPosition);dissolve_divider(lastKnownScrollPosition);if(screen.width<=1600){alert('right')}
