...
const particle_material=new THREE.PointsMaterial({size:0.005,color:0xa165ff,})
...
var star_cluster_geometry2=new THREE.SphereBufferGeometry(2,20,15);var star_cluster_material2=new THREE.PointsMaterial({size:0.03,transparent:true,color:'blue'})
