...
const particle_material=new THREE.PointsMaterial({size:0.005,transparent:true,color:'white'})
...
start_cluster_mesh.position.x=-2.5;start_cluster_mesh.position.y=-2.5;start_cluster_mesh.position.z=.5;scene.add(start_cluster_mesh)
