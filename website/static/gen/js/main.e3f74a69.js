...
var geometry=new THREE.SphereBufferGeometry(1,20,20);var material=new THREE.MeshLambertMaterial({color:0x77FFC0});var textureLoader=new TextureLoader()
...
mesh1.rotation.y+=0.01;mesh2.rotation.x+=0.01;particles_mesh.rotation.y=(.009*elasped_time)
