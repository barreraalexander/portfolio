...
const particles_geomtery=new THREE.BufferGeometry;const particles_count=15000;const position_array=new Float32Array(particles_count*3)
for(let i=0;i<particles_count*3;i++){position_array[i]=Math.random()}
particles_geomtery.setAttribute('position',new THREE.BufferAttribute(position_array,3))
const particles_mesh=new THREE.Points(particles_geomtery,material)
