...
const observer = new IntersectionObserver (function(entries, observer){
    entries.forEach(entry => {
        if (entry.isIntersecting){
          // entry.target.classList.add('apply_shifting_bw_reverse')
          // entry.target.classList.remove('apply_shifting_bw')
          entry.target.classList.remove('apply_shifting_bw_reverse')
          // entry.target.classList.add('apply_shifting_bw')
        } else {
          // entry.target.classList.add('apply_shifting_bw')
          entry.target.classList.add('apply_shifting_bw_reverse')
          // entry.target.classList.remove('apply_shifting_bw_reverse')
...
observer.observe(talents_section)
